...
## Project Structure
    ...
    ├── testmembersasa_dev_45120  # Django project configurations
...
1. Clone this repo and `cd testmembersasa_dev_45120`
...
2. Clone this repo and `cd testmembersasa_dev_45120`
